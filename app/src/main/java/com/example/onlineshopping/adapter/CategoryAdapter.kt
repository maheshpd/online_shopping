...
import com.example.onlineshopping.activity.ListItemsActivity
import com.example.onlineshopping.databinding.ViewholderCategoryBinding
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.Viewholder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            ...
            android.os.Handler(Looper.getMainLooper()).postDelayed({
                var intent = Intent(holder.itemView.context, ListItemsActivity::class.java).apply {
